<div x-data="fileUpload()">
    <div class="z-10 top-0 w-full h-full flex" x-data="{isUploading: false, progress: 0}">
        <div class="extraOutline p-4 bg-white w-max m-auto rounded-lg  bg-gray-400">
            <div class="file_upload p-5 relative rounded-lg"
                 style="width: 800px">
            ...
            <div class="bg-gray-200 h-[5px] w-full mt-3" x-show="isUploading">
                <div class="bg-blue-500 h-[3px]"
        ...
        <div class="">
            @if ($uploaded_file)
                <div class="p-4 border rounded mt-2  bg-gray-400">
                    ...
                    <button wire:click="removeUpload" class="mt-2 bg-red-500 text-white p-2 rounded">Remove</button>
                </div>
            @endif
        </div>
    </div>
                    ...
                    <div class="p-4 border rounded mt-2 bg-gray-400 w-full flex flex-row justify-between">
                        <div class="float-start flex flex-row">
                            ...
                            <div>
                                ...
                                <p>Paid: <strong>{{ $file->is_paid ? 'Yes' : 'No' }}</strong></p>
        ...
        function fileUpload() {
            return {
                ...
                uploadFile(file) {
                    ...
                    // Use upload instead of uploadMultiple for a single file
                ...
                removeUpload() {
                    // Adapt to single file
                @this.removeUpload('uploaded_file')
                    ;
                },
            }
        }
